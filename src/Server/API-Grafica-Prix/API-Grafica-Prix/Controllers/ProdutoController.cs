    ...
    public class ProdutoController : ControllerBase
    {
        ...
        public async Task<ActionResult> PesquisarPorId(int id)
        {
            ...
            var produtoComImagem = new
            {
                ...
                Imagem = Convert.ToBase64String(produto.Imagem)
            };

            return Ok(produtoComImagem);
        }
        ...
        public async Task<IActionResult> AtualizarProduto(int id, [FromForm] IFormFile Imagem, [FromForm] Produto Model)
        {
            try
            {
                ...
                // Atualize as propriedades do produto existente com base nos dados do novo produto
